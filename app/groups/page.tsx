          ...
          <div className="grid gap-4">
            {groups.map((group) => (
              <Link
                ...
                className="group rounded-xl border border-white/10 bg-white/5 p-5 transition-all hover:border-yellow-400/50 hover:bg-white/10"
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-400">
                      Code: <span className="font-mono text-yellow-400">{group.join_code}</span>
                    </p>
                  </div>
