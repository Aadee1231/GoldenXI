...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" fill="none">
  ...
  <g transform="translate(600, 240)">
    ...
    <path d="M-40 170 H40" stroke="#FACC15" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <text x="600" y="420" text-anchor="middle" font-family="Arial, sans-serif" font-size="72" font-weight="bold" fill="#FACC15">GoldenXI</text>
  <text x="600" y="480" text-anchor="middle" font-family="Arial, sans-serif" font-size="32" fill="#A1A1AA">World Cup Bracket Challenge</text>
</svg>
`;
